/**
 * Default South Indian Menu Data for Sri Sai Lakshmi Mess
 * Provides instant offline & fallback menu availability in production
 */
...
export function filterFallbackMenu({ category, search, popular } = {}) {
